...
import com.nlab.practice.core.effect.system.impl.ActivitySystemEffectReceiver
import com.nlab.practice.core.effect.system.impl.AndroidSystemEffect
import com.nlab.practice.core.effect.system.impl.AndroidSystemEffectFlowProvider
import com.nlab.practice.core.lifecycle.CompositeLifecycleEventObserver
import com.nlab.practice.core.lifecycle.SimpleViewModelFactory
import com.nlab.practice.core.lifecycle.lifecycleEventObserver
import com.nlab.practice.core.view.recyclerview.CommonRecyclerViewAdapter
import com.nlab.practice.core.view.recyclerview.flow.FlowItem
import com.nlab.practice.core.view.recyclerview.flow.FlowSupportViewHolder
import com.nlab.practice.core.view.recyclerview.flow.FlowSupportViewHolderLifecycle
import com.nlab.practice.databinding.ActivityHomeBinding
import com.nlab.practice.domain.detail.DomainDestinationToSystemEffect
import com.nlab.practice.domain.detail.DomainViewHolderMakerMapper
import com.nlab.practice.domain.detail.NavigateMenuRepositoryImpl
