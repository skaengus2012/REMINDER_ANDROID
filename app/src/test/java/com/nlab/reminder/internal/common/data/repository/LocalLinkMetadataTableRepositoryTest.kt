...
import com.nlab.reminder.domain.common.data.model.genLink
import com.nlab.reminder.domain.common.data.model.genLinkMetadata
...
internal class LocalLinkMetadataTableRepositoryTest {
    ...
    fun `Get cached linkMetadata from dao`() = runTest {
        ...
        val linkMetadataTable = linkMetadataTableRepository.get()
            .take(1)
            .first()
        assertThat(linkMetadataTable, equalTo(LinkMetadataTable(mapOf(link to linkMetadata))))
    }
}
