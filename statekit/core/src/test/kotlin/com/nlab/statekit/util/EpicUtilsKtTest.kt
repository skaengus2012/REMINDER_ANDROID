...
internal class EpicUtilsKtTest {
    @Test
    fun testBuildEpic() {
        val expectedSources: List<EpicSource<com.nlab.statekit.TestAction>> = List(genInt("#0")) {
            EpicSource(
                flowOf(com.nlab.statekit.TestAction.genAction()),
    ...
    fun testBuildDslEpic() = runTest {
        val expectedAction = com.nlab.statekit.TestAction.genAction()
