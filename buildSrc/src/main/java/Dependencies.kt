...
object Dependencies {
    ...
    const val ANDROID_CONSTRAINT_LAYOUT = "androidx.constraintlayout:constraintlayout:${DependenciesVersions.ANDROID_CONSTRAINT_LAYOUT}"
    const val ANDROID_RECYCLER_VIEW = "androidx.recyclerview:recyclerview:${DependenciesVersions.ANDROID_RECYCLER_VIEW}"
    const val ANDROID_LIFECYCLE_VIEWMODEL = "androidx.lifecycle:lifecycle-viewmodel-ktx:${DependenciesVersions.ANDROID_LIFECYCLE}"
