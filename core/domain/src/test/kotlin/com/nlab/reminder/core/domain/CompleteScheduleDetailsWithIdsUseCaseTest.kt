 ...
 * @author thalys
 */
internal class CompleteScheduleDetailsWithIdsUseCaseTest {
    @Test
    fun `Given empty ids, When invoked, Then repository never works`() = runTest {
        ...
        verify(repository, never()).updateBulk(any())
    ...
    fun `Given not empty ids, When invoked, Then repository invoke update`() = runTest {
        ...
        verify(repository, once()).updateBulk(UpdateSchedulesQuery.Completes(buildMap {
