...
fun ScheduleListContent(
    ...
    fragmentRef?.let { fragment ->
        ...
        LaunchedEffect(fragment, onSelectionUpdated) {
            fragment.onSelectionUpdateConsumerChanged(observer = onSelectionUpdated)
        }
        ...
        LaunchedEffect(fragment, onCompletedSchedulesCleanupRequested) {
            fragment.onCompletedSchedulesCleanupConsumerChanged(consumer = onCompletedSchedulesCleanupRequested)
        }
    }
}