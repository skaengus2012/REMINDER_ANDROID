 ...
 * @author Thalys
 */
class StateKitAndroidPluginTest {
    @Test
    fun `When get global store configuration, Then return empty configuration`() {
        val storeConfiguration = StateKitAndroidPlugin.globalStoreConfiguration
    ...
    fun `Given custom configuration, When set configuration, Then return custom configuration`() {
        ...
        StateKitAndroidPlugin.setGlobalStoreConfiguration(configuration)

        val actualConfiguration = StateKitAndroidPlugin.globalStoreConfiguration
